...
<img src="/icons/AutoRus.png" title="АвтоРусь" alt="autorus" width="100"/>&nbsp; <br />
`АвтоРусь - Группа компаний. Автобизнес` `05.2024 - 10.2025` <br />
<b>Frontend-разработчик направления АСП</b> <br />
Поддержание и доработка Web-приложения по продаже автомобилей с пробегом React<br />

<img src="/icons/FreshAuto.png" title="FreshAuto" alt="freshauto" width="100"/>&nbsp; <br />
`Fresh Auto - Автомобильный маркетплейс.` `10.2024 - 05.2025` <br />
<b>Frontend-разработчик обособленного направления "Аукцион"</b> <br />
Поддержание и разработка аукциона автомобилей с пробегом на React
